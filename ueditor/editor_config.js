...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["undo","redo","forecolor","backcolor","bold","italic","underline","strikethrough","insertunorderedlist","insertorderedlist","unlink","link","blockquote","highlightcode","source"]]
